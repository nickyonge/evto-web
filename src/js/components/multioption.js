...
<div class="multichoicelist">
  ...
  <div class="listselect">
    <input type="radio" name="menu" id="profile" checked="" />
    <label for="profile" class="value">
    ...
    <input type="radio" name="menu" id="account" />
    <label for="account" class="value">
      <svg id="Line" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
        <path fill="#ffffff" id="XMLID_1646_"
    ...
    <input type="radio" name="menu" id="appearance" />
    <label for="appearance" class="value">
    ...
    <input type="radio" name="menu" id="accessibility" />
    <label for="accessibility" class="value">
      <svg id="svg8" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
        <g id="layer1" transform="translate(-33.022 -30.617)">
          <path fill="#ffffff" id="path26276"
    ...
    <input type="radio" name="menu" id="notifications" />
    <label for="notifications" class="value">
