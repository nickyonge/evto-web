...
declare global {
     ...
     * 
     * {@linkcode BlendMode} is both a type and string-literal enum.
    ...
    var BlendMode: {
        ...
        readonly ColorDodge: 'color-dodge';
